...
import { LogOut, Users, BarChart, ExternalLink, Search } from 'lucide-react';
  ...
  return (
    <>
      ...
      <main className="flex-1 space-y-4 p-4 md:p-8">
        ...
        <div className="mt-8 text-center text-muted-foreground border-t pt-8">
            <h3 className="text-xl font-semibold tracking-tight">Future Features</h3>
            <p className="mt-2">Content Management for the Gallery and Service pages will be available here soon.</p>
        </div>
      </main>
    </>
  );
