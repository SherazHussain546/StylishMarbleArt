...
export default function DonatePageClient() {
  ...
  const content = {
    ...
    faqs: [
        ...
        {
            question: { en: 'What happens if a fundraising goal isn\'t met?', ur: 'اگر فنڈ ریزنگ کا ہدف پورا نہ ہو تو کیا ہوتا ہے؟' },
            answer: { en: 'We are committed to fulfilling our promises. We will do our best to complete the stated goal with the funds raised. If we are unable to, any donations for that goal will be moved to the next timeline goal to maximize their impact. If no goals are achieved, all collected funds will be donated to local mosques as general Sadaqa.', ur: 'ہم اپنے وعدوں کو پورا کرنے کے لیے پرعزم ہیں۔ ہم اٹھائے گئے فنڈز سے بیان کردہ ہدف کو پورا کرنے کی پوری کوشش کریں گے۔ اگر ہم ایسا کرنے سے قاصر ہیں، تو اس مقصد کے لیے کوئی بھی عطیہ اگلے ٹائم لائن کے ہدف میں منتقل کر دیا جائے گا تاکہ ان کے اثرات کو زیادہ سے زیادہ کیا جا سکے۔ اگر کوئی بھی ہدف حاصل نہیں ہوتا ہے، تو جمع کی گئی تمام رقم مقامی مساجد کو عمومی صدقہ کے طور پر عطیہ کر دی جائے گی۔' },
        },
    ],
    helpTitle: {
        en: 'Need Help?',
                        ...
                        return (
                            <li key={index} className="flex gap-4 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-muted-foreground text-sm">{cause.description[language]}</p>
                                </div>
                            </li>
                        );
                    })}
