    ...
    serviceList: [
       {
        ...
        images: [
          { src: '/Gallery/Grave/8.png', alt: 'Elegant gravestone', hint: 'gravestone' },
          { src: '/Gallery/Headstone/8.png', alt: 'Elegant gravestone', hint: 'gravestone' },
          { src: '/Gallery/Headstone/4.png', alt: 'Grave preparation', hint: 'cemetery work' },
          { src: '/Gallery/Grave/6.png', alt: 'Elegant gravestone', hint: 'gravestone' },
          { src: '/Gallery/Headstone/5.png', alt: 'Finished memorial', hint: 'marble memorial' },
          { src: '/Gallery/Grave/14.png', alt: 'Elegant gravestone', hint: 'gravestone' },
          { src: '/Gallery/Headstone/7.png', alt: 'Another gravestone', hint: 'gravestone design' },
          { src: '/Gallery/Headstone/9.png', alt: 'Engraving detail', hint: 'engraving detail' },
          { src: '/Gallery/Grave/4.png', alt: 'Elegant gravestone', hint: 'gravestone' },
          { src: '/Gallery/Headstone/10.png', alt: 'Memorial in cemetery', hint: 'cemetery memorial' },
          { src: '/Gallery/Grave/10.png', alt: 'Elegant gravestone', hint: 'gravestone' },
          { src: '/Gallery/Headstone/13.png', alt: 'Custom headstone', hint: 'custom headstone' },
          { src: '/Gallery/Headstone/14.png', alt: 'Polished granite grave', hint: 'granite grave' },
          { src: '/Gallery/Headstone/16.png', alt: 'Family grave marker', hint: 'family grave marker' },
          { src: '/Gallery/Headstone/18.png', alt: 'Simple grave design', hint: 'simple grave' },
        ],
      },
      {
        ...
        images: [
          { src: '/Gallery/HomeDecor/1.png', alt: 'Marble kitchen countertop', hint: 'kitchen countertop' },
          { src: '/Gallery/HomeDecor/2.png', alt: 'Marble flooring', hint: 'marble floor' },
          { src: '/Gallery/HomeDecor/3.png', alt: 'Marble wall cladding', hint: 'wall cladding' },
          { src: '/Gallery/tom/artist.png', alt: 'Luxury marble bathroom', hint: 'marble bathroom' },
          //{ src: 'https://placehold.co/600x414', alt: 'Custom marble staircase', hint: 'marble staircase' },
          //{ src: 'https://placehold.co/600x415', alt: 'Marble fireplace', hint: 'marble fireplace' },
          //{ src: 'https://placehold.co/600x416', alt: 'Kitchen island detail', hint: 'kitchen island' },
          ],
      },
      {
        ...
        images: [
          { src: '/Gallery/Charity/1.png', alt: 'Intricate marble engraving', hint: 'marble engraving' },
          { src: '/Gallery/Christin/2.png', alt: 'Engraved text on marble', hint: 'text engraving' },
          { src: '/Gallery/Government/1.png', alt: 'Engraved portrait on stone', hint: 'portrait engraving' },
          { src: '/Gallery/Government/2.png', alt: 'Floral pattern engraving', hint: 'floral engraving' },
          { src: '/Gallery/Government/3.png', alt: 'Calligraphy on marble', hint: 'marble calligraphy' },
          { src: '/Gallery/Government/5.png', alt: 'Logo engraved on stone', hint: 'logo engraving' },
          { src: '/Gallery/Hindu/1.png', alt: 'Detailed stone carving', hint: 'stone carving' },
          { src: '/Gallery/HomeDecor/1.png', alt: 'Plaque engraving', hint: 'plaque engraving' },
          { src: '/Gallery/HomeDecor/2.png', alt: 'Engraved memorial text', hint: 'memorial text' },
          { src: '/Gallery/HomeDecor/3.png', alt: 'Artificial marble design', hint: 'artificial marble' },
        ],
      },
      {
        ...
        images: [
          /**{ src: 'https://placehold.co/600x430', alt: 'Polishing a marble surface', hint: 'marble polishing' },
          { src: 'https://placehold.co/600x431', alt: 'Repairing a chipped marble edge', hint: 'marble repair' },
          { src: 'https://placehold.co/600x432', alt: 'Restored marble memorial', hint: 'restored memorial' },
          { src: 'https://placehold.co/600x433', alt: 'Cleaning old marble', hint: 'marble cleaning' },
          { src: 'https://placehold.co/600x434', alt: 'Stain removal from marble', hint: 'marble stain removal' },
          { src: 'https://placehold.co/600x435', alt: 'Crack repair on floor', hint: 'floor repair' },
          { src: 'https://placehold.co/600x436', alt: 'Restoring shine to countertop', hint: 'countertop restoration' },
          { src: 'https://placehold.co/600x437', alt: 'Antique marble restoration', hint: 'antique restoration' },
          { src: 'https://placehold.co/600x438', alt: 'Sealing marble surface', hint: 'sealing marble' },
          { src: 'https://placehold.co/600x439', alt: 'Before and after restoration', hint: 'before after' }, **/
        ],
      },
    ],
  },
  ...
  aboutPage: {
    ...
    values: [
      ...
      },
      {
        ...
        description: {
          en: 'We operate with honesty and transparency, ensuring you feel confident and supported.',
          ur: 'ہم ایمانداری اور شفافیت کے ساتھ کام کرتے ہیں، اس بات کو یقینی بناتے ہوئے کہ آپ پراعتماد اور معاون محسوس کریں۔',
        },
      },
    ],
  },
  contactPage: {
    title: { en: 'Get in Touch', ur: 'رابطے میں رہیں' },
    description: {
      en: 'We are here to help. Whether you have a question about our services or need guidance, please do not hesitate to reach out. Fill out the form below or contact us directly.',
      ur: 'ہم مدد کے لیے حاضر ہیں۔ چاہے آپ کو ہماری خدمات کے بارے میں کوئی سوال ہو یا رہنمائی کی ضرورت ہو، براہ کرم رابطہ کرنے میں ہچکچاہٹ محسوس نہ کریں۔ نیچے دیا گیا فارم پر کریں یا ہم سے براہ راست رابطہ کریں۔',
    },
    form: {
